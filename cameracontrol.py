...
class App(object):
  ...
  def install(self, *args, **kwargs):
    ...
    script_path = Path('record.lua')
    ini_path = Path('reaper-kb.ReaperKeyMap')
    script = f"""
-- This file was automatically generated by CameraControl. DO NOT MODIFY THIS BY HAND!
...
""".strip()
    ...
    id = "RS2f776763b6a31b0662406cb5b424f8dee4b97b7a"
    ini = f"""
SCR 4 0 {id} "Custom: {script_path.name}" {script_path.absolute()}
ACT 0 0 "afad72b441294db3a0f40e747ecb40bf" "Custom: opa" _{id}
""".strip()
